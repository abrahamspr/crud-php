  ...
  <div class="mx-auto">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php
        header("refresh:5;url=index.php");//refresh otomatis 5 detik
        }
        ?>
        <?php
        if ($sukses) {
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="fakultas" id="fakultas">
                ...
                <option value="ti" <?php if ($fakultas == "ti") echo "selected" ?>>Teknologi Industri</option>
                <option value="ik" <?php if ($fakultas == "ik") echo "selected" ?>>Ilmu Komputer</option>
              </select>
            </div>
          </div>
          <div class="col-12">
